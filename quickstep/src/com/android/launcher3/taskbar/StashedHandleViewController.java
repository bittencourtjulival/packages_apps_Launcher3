...
import static com.android.launcher3.taskbar.TaskbarManager.GESTURE_NAVBAR_HEIGHT_MODE;
import static com.android.launcher3.taskbar.TaskbarManager.GESTURE_NAVBAR_LENGTH_MODE;
...
public class StashedHandleViewController implements TaskbarControllers.LoggableTaskbarController,
    ...
    public void init(TaskbarControllers controllers) {
        ...
        int handleHeightMode = SettingsCache.INSTANCE.get(mActivity).getValueInt(GESTURE_NAVBAR_HEIGHT_MODE, 3);
        ...
        int handleWidthMode = SettingsCache.INSTANCE.get(mActivity).getValueInt(GESTURE_NAVBAR_LENGTH_MODE, 1);
